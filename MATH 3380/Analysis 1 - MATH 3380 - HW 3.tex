...
Suppose $\exists$ an open set A equal to S$\pr$. \

By definition, A = int S, and $\fa s \in A$, $\exists$ $\ep > 0$ st N(x, $\ep$) $\sbs$ A. \
...
See that x $< \frac{m}{n	} < y$, $\frac{m}{n}$ is a rational number, and $\frac{m}{n} \in$ A. \
