...
\lt{x \mem \uf{f}{-1}(\bnt{\br}{H}) and H \sbs \br}
...
x $\not\in$ \uf{f}{-1}(H) \lla \textbf{I know you told us to do this in class, but isn't this only true if f is injective?}

x \mem \bnt{\br}{\uf{f}{-1}(H)}

\

\lla 

\lt{x \mem \bnt{\br}{\uf{f}{-1}(H)} and H \sbs \br}
...
x \mem \uf{f}{-1}(\bnt{\br}{H}) \lla \textbf{Same question here.}

\

So, at this point we have shown that:
\step{\textrm{for } H \sbs \br, \tab \uf{f}{-1}(\bnt{\br}{H}) \eql \bnt{\br}{\uf{f}{-1}(H)}}{1}
\lra 

\as{f : \br \lra \br is continuous}

\wts{\uf{f}{-1}(H) is a closed set whenever H is closed OR H is an open set whenever \uf{f}{-1}(H) is open.}

\lt{H \sbs \br be closed}

So \bnt{\br}{H} is open.

By Corollary 5.2.15, 

\uf{f}{-1}(\bnt{\br}{H}) is open.

Thus, by \bpth{1},

\bnt{\br}{\uf{f}{-1}(H)} is open, and
...
\as{\uf{f}{-1}(H) is a closed set whenever H is closed AND H is an open set whenever \uf{f}{-1}(H) is open.}

\wts{for every open set G \sbs \br, \exs an open set H \sbs \br st \uf{f}{-1}(G) \eql H \inn D, i.e. continuity on \br}

\lt{G \sbs \br be an open set}

So, \bnt{\br}{G} is a closed set.

By our assumption, \uf{f}{-1}(\bnt{\br}{G}) is also closed.

By \bpth{1}, \bnt{\br}{\uf{f}{-1}(G)} is also closed.

So, \uf{f}{-1}(G) is open.

By Corollary 5.2.15, f is continuous on \br
