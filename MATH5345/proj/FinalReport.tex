...
\balist
\item Normality of errors: Based on figure 2, it appears that the residuals are mostly normally distributed with a right tail.
...
\item Linearity: Based on the significance of multiple coefficient estimates for each regressor in Table 1, it appears that our response variable is linearly related to our predictor variables.
\elist
