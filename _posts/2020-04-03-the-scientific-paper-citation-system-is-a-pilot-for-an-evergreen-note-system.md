...
The answer is accessibility. I'm not talking about papers being hidden behind paywalls (which is also an issue). The issue is that when the average person reads a scientific paper, they get nothing out of it. It's like it's encrypted.
...
Unfortunately, for the average paper, this is very likely to happen *alot*. And this assumes that the paper was written well! And that you have some prior knowledge!
