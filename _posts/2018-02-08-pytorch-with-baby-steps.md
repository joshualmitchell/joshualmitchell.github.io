...
<p>3) <a href="#three">Calculating Our Gradient</a>: calculate our gradient based on the linear layer</p>
<p>4) <a href="#four">Calculating Our Loss</a>: calculate our loss based on the linear layer</p>
<p>5) <a href="#five">Recalculating/Updating Our Weights</a>: calculate the change in our weights based on the gradient wrt loss</p>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="3)--Calculating-Our-Gradient-(of-our-linear-layer-wrt-our-input)">3)  Calculating Our Gradient (of our linear layer wrt our input)<a class="anchor-link" href="#3)--Calculating-Our-Gradient-(of-our-linear-layer-wrt-our-input)">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<span class="c1"># at this point, we want the gradient of our linear layer with respect to our original input, x</span>
...
<span class="c1"># we have to call the backward() function from our predicted results in order to compute gradients with respect to x</span>

<span class="n">predicted_y</span><span class="o">.</span><span class="n">backward</span><span class="p">()</span>
<span class="nb">print</span><span class="p">(</span><span class="n">x1_var</span><span class="o">.</span><span class="n">grad</span><span class="p">)</span>
<span class="nb">print</span><span class="p">(</span><span class="s2">&quot;----------------------------------------&quot;</span><span class="p">)</span>
<span class="c1"># This is the gradient Tensor that holds the partial derivatives of our linear function with respect to each entry in x1</span>
</pre></div>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="4)--Calculating-The-Loss-Function">4)  Calculating The Loss Function<a class="anchor-link" href="#4)--Calculating-The-Loss-Function">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="5)--Recalculating/Updating-Our-Weights-(using-gradient-of-loss-wrt-weights)">5)  Recalculating/Updating Our Weights (using gradient of loss wrt weights)<a class="anchor-link" href="#5)--Recalculating/Updating-Our-Weights-(using-gradient-of-loss-wrt-weights)">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="c1"># Now, instead of calculating the gradient of our linear layer wrt our inputs (x) in lesson 3,</span>
<span class="c1"># we&#39;re going to calculate the gradient of our loss function wrt our weights / biases</span>
...
<div class="inner_cell">
<div class="text_cell_render border-box-sizing rendered_html">
<h1 id="7)--Making-Our-Epochs-Only-Use-A-Subset-Of-The-Data-(i.e.-a-&quot;minibatch&quot;)">7)  Making Our Epochs Only Use A Subset Of The Data (i.e. a "minibatch")<a class="anchor-link" href="#7)--Making-Our-Epochs-Only-Use-A-Subset-Of-The-Data-(i.e.-a-&quot;minibatch&quot;)">&#182;</a></h1>
</div>
</div>
</div>
<div class="cell border-box-sizing text_cell rendered"><div class="prompt input_prompt">
