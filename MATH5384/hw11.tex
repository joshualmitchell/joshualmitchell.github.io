...
Because \uw{Z}{16} is of order 16, and \av{\uw{Z}{2}} divides 8, there is an element of order 16 in \uw{Z}{16} \edp \uw{Z}{2}, let's call it \uw{z}{16}.

Thus, \uw{z}{16} \mem \uw{Z}{16} \edp \uw{Z}{2}.

Because $\phi$ is OP, \exs z \mem \uw{Z}{4} \edp \uw{Z}{4} such that $\phi$(\uw{z}{16}) \eql z and \av{z} \eql 16.

However, there is no element of order 16 in \uw{Z}{4} \edp \uw{Z}{4}. A contradiction.
