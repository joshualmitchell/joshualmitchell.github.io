...
\ssc{Exercise 20}{
\textbf{Find a subgroup of \uw{Z}{12} (\mt{+}) \uw{Z}{18} that is isomorphic to \uw{Z}{9} (\mt{+}) \uw{Z}{4}.}
}
\ssc{Exercise 22}{
\textbf{Determine the number of elements of order 15 and the number of cyclic subgroups of order 15 in \uw{Z}{30} (\mt{+}) \uw{Z}{20}.}
}
}
