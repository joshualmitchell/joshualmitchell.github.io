...
Assigned: Page 22, prove Properties of Functions Theorem parts 2, 3, and 4
...
\begin{enumerate}
  \item \lcg(\bta\afa) \eql (\lcg\bta)\afa (associativity).
...
So, \lcg(\bta\afa) \eql (\lcg\bta)\afa.
  ...
  \item If \afa and \bta are one-to-one, then \bta\afa is one-to-one.
  \item If \afa and \bta are onto, then \bta\afa is onto.
  \item If \afa is one-to-one and onto, then there is a function \uf{\afa}{-1} from B onto A such that (\uf{\afa}{-1}\afa)(a) \eql a, \fa a \mem A and (\afa\uf{\afa}{-1})(b) \eql b, \fa b \mem B.
\end{enumerate}
