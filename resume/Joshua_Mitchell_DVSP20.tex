...
%--------------------SECTIONS-----------------------------------
\begin{center}
I'm a full-stack (primarily front-end) developer with 2 years of engineering experience. I'm looking for a full-time software development role to write code that delivers an incredible user experience. I graduate May 2020, but I can start earlier, if needed. \end{center}
