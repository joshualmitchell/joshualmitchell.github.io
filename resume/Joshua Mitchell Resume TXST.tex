...
\par{\centering
	...
	(512) 537-9446
	$\mid$
	\href {mailto:jlm346@txstate.edu}{jlm346@txstate.edu}
	$\mid$
...
\textsc{May 2018 -} & Graduate Research Assistant at \textsc{Texas State University}, San Marcos, TX \\
\emph{Present} & \footnotesize{I'm finding ways to improve object detection and localization on high-resolution satellite image datasets (xView) using deep learning under the guidance of Dr. Jelena Tesic.
 ...
 \emph{May 2018} & \footnotesize{I taught Algebra and pre-Calculus course material to undergraduates in a classroom setting.
