...
%--------------------SECTIONS-----------------------------------
\begin{center}
I'm a developer with significant experience in front-end engineering, data analytics, and, most recently, data engineering. I'm looking for a full-time development role (to start immediately) where I can enhance my knowledge and add value.
\end{center}
...
\textsc{Aug 2017 -} & \textbf{Masters Student}  | \textsc{Texas State University}, San Marcos, TX \\
...
\underline{Familiar}: Angular (1.0), React, HTML/CSS, JavaScript, SQL, Jenkins, Google Analytics (lelon.io)
