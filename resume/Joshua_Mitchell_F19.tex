...
\emph{Present} & \small{
	\textbf{Tech}: PyTorch, Numpy, Matplotlib, OpenCV, Pandas, Scikit-Learn, Python, Unix
	}
...
Aug 2017 & \small{
	\textbf{Tech}: Angular.js, HTML, CSS, Javascript, REST, SQL}
 ...
 May 2016 & \small{
 	\textbf{Tech}: Angular.js, HTML, CSS, Javascript, REST, SQL, Balsamiq, Unix}
