...
\underline{Data}: Python (Numpy, matplotlib, Pandas, Scikit-Learn, PyTorch), R, ggplot2, SQL
...
\textsc{health-data-anon} & Presented a project at Open Austin meet up for a variation on differential \\
& privacy involving generating a fake distribution based on the parameters \\
& of the original data using R and ggplot2. \\
...
&  that tells her the day her fire fighter son works next. \\
