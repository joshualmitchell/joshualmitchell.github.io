...
\underline{Data}: Python (numpy, matplotlib, pandas, scikit-learn), R, SQL, Matlab
...
\section{Selected Personal Projects}
\begin{tabular}{rl}
 \textsc{\href {https://github.com/joshualmitchell/DrawingGuide}{DrawingGuide}} & Created a machine learning powered image comparison algorithm \\
...
Feel free to look at my GitHub (\href {https://github.com/joshualmitchell}{github.com/joshualmitchell}) and website (\href {http://lelon.io/blog/2018/01/04/to-potential-employers}{lelon.io}), to see more details about what I'm up to currently and what my roadmap looks like. 

DrawingGuide (hyperlinked above) is my latest project.
