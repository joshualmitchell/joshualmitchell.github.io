...
%--------------------SECTIONS-----------------------------------
\begin{center}
I analyze data and write code to add business value, particularly in the marketing domain. *** To be expanded upon ***
\end{center}
...
** Remove some of these that are irrelevant ** Python (numpy, pandas, matplotlib, sk-learn), git, Unix SQL, R, Matlab, HTML/CSS, JavaScript, Angular.js, C++, MPI, OpenMP, CUDA, Google Cloud (Dataflow, BigQuery, Cloud Composer), Concourse, Airflow, Spark ** Add: Google Analytics, Adobe Experience Cloud **
...
Aug 2019 & \small{
	...
	- helped migrate an on-premise Hadoop-based data pipeline to Google Cloud as part of a bigger \$500,000/yr cost savings project. ** adding motivation for proj ** } \\
 \multicolumn{2}{c}{} \\
...
\begin{tabular}{rl}	
	...
	(part-time, &\normalsize \textsc{GPA}: 3.73/4, Focus: \underline{Data Mining \& Natural Language Processing on Marketing Data} \\ 
