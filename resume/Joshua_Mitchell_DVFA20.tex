...
%--------------------SECTIONS-----------------------------------
\begin{center}
I'm a developer with significant experience in front-end engineering, machine learning engineering, and, most recently, data engineering. I'm looking for a Summer 2020 internship where I can enhance my knowledge and add value in one of those domains.
\end{center}
\section{Technical Skills}

\textbf{Python} (numpy, pandas, matplotlib, sk-learn), \textbf{SQL}, Google Cloud (BigQuery, Composer)

\textbf{HTML/CSS}, \textbf{JavaScript}, \textbf{Angular.js}, C++, Java, git, Jenkins, Concourse
